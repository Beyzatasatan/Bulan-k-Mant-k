...
fren_basinci = kontrol.Consequent(mat.arange(0, 100, 1), 'fren basinci')
...
# Örnek bir giriş değeri simülasyonu
#fren_simulasyonu.input['mesafe'] = 50
#fren_simulasyonu.input['hiz'] = 80
...
if (v/2<=s):
    ...
    frenleme.compute()
    print("fren_basinci",frenleme.output['fren_basinci'])
    print("yeni hız degerei",v-(v-frenleme.output['fren_basinci']/100))
